...
from clients_fed_single_2 import ClientsGroupMultiTargetAttackedNonIID
...
flags.DEFINE_boolean('scaled', False, help='whether to use scaled version of the model')
...
def train():
    ...
    clients_group = ClientsGroupMultiTargetAttackedNonIID(
        FLAGS.dataset_name, FLAGS.batch_size, FLAGS.client_num, FLAGS.num_targets, device, scaled=FLAGS.scaled, batch_size_attack_per=FLAGS.batch_size_attack_per, 
        ...
        adaptive_lr=FLAGS.adaptive_lr, ema_scale=FLAGS.ema_scale, data_distribution_seed=FLAGS.data_distribution_seed, defense_technique=FLAGS.defense_technique)
